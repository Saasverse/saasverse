...
const TECH_SERVICES = [
  ...
  { title: 'ServiceNow',               badge: 'Platform',   desc: 'ServiceNow implementation, customisation, and integration services to streamline enterprise workflows and processes.',    href: '/services',                            accent: TK },
