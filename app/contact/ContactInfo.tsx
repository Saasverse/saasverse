...
if (!contact) {
          ...
          <div className="overflow-hidden rounded-[36px] border border-slate-200 bg-white shadow-[0_25px_80px_rgba(15,23,42,0.08)]">
            ...
            <div className="border-b border-slate-100 p-8 md:p-10">
              <div className="flex items-start gap-5">
                <div className="flex h-14 w-14 shrink-0 items-center justify-center rounded-2xl bg-cyan-50 text-[#003e95]">
            ...
            <div className="grid gap-5 p-8 md:grid-cols-2 md:p-10">
              {/* Phone */}
              <div className="group rounded-3xl border border-slate-200 bg-slate-50 p-6 transition-all duration-300 hover:-translate-y-1 hover:border-[#003e95] hover:bg-white hover:shadow-lg">
                ...
                <a
                  ...
                  className="text-xl font-bold text-slate-900 transition hover:text-[#003e95]"
                >
              ...
              <div className="group rounded-3xl border border-slate-200 bg-slate-50 p-6 transition-all duration-300 hover:-translate-y-1 hover:border-[#003e95] hover:bg-white hover:shadow-lg">
                ...
                <a
                  ...
                  className="break-all text-xl font-bold text-slate-900 transition hover:text-[#003e95]"
                >
  ...
  Object.entries(socialLinks as SocialLinks).map(([key, value]) => (
                    <a
                      ...
                      className="group flex items-center gap-4 rounded-2xl border border-slate-200 bg-white p-4 transition-all duration-300 hover:-translate-y-1 hover:border-[#003e95] hover:shadow-lg"
                    >
                      <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-slate-100 text-xl text-slate-700 transition-all duration-300 group-hover:bg-[#003e95] group-hover:text-white">
